%%
Look at [2026-05-05 - Route decision after extraction.md](Learn/Dev/Progress Review/2026-05-05 - Route decision after extraction.md) to understand the whole picture. Combined with our discussion and understanding of youtube-transcript-api and yt-dlp, I am starting to write the skill. The steps I have planned are in beneath the section ## Decision - Don't solve the issue - focus on finishing the flow, containing the problems and issues I have to solve. Please answer the questions to help me develop the extracting-youtube skill. After replying the questions, write a plan to develop the skills.

Also, write the plan and response into [Discussion.md](Learn/Dev/Extract Skill Develop/Codex/Discussion.md)  for further reference.
%%
