...
- [`Claude/yt-dlp/Claude log.md`](Learn/Dev/05-02%20yt%20api%20investigation/yt-dlp/Claude/Claude%20log.md), [`field_inventory.md`](Learn/Dev/05-02%20yt%20api%20investigation/yt-dlp/Claude/field_inventory.md) — Step 2 detail
- [`Claude/youtube-transcript-api/Claude log.md`](Learn/Dev/05-02%20yt%20api%20investigation/youtube-transcript-api/Claude/Claude%20log.md), [`field_inventory.md`](Learn/Dev/05-02%20yt%20api%20investigation/youtube-transcript-api/Claude/field_inventory.md) — Steps 3–5 detail
